...
## Projets récents
- 🐍 [Bot Rust Python](https://github.com/benoitchocot/bot-rust-python) : Script pour un bot discord pour avoir des notifications en fonction du contenu d'un tweet
